...
const TransactionsCard: React.FC<Transaction> = ({
    addressTo,
    addressFrom,
    timestamp,
    message,
        ...
        >
            <div className="flex flex-col items-center w-full mt-3">
                ...
                <div className="bg-black p-3 px-5 w-max rounded-3xl -mt-5 shadow-2xl">
                    <p className="text-[#96c34e] font-bold">{timestamp}</p>
                </div>
            </div>
        </div>
    );
...
const Transactions: React.FC = () => {
    ...
    if (!context) {
        return <p className="text-white text-center">Loading transactions...</p>;
    }
